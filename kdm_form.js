(function(global) {
  ...
  var pledgeTemplate = _.template(
    ...
    +   '<label for="pledge" class="control-label col-md-4 col-xs-4">Pledge</label>'
    ...
    +  '</div>'
    +  '<div class="form-group">'
    +   '<label for="shipping" class="control-label col-md-4 col-xs-4">Shipping</label>'
    +   '<div class="col-md-4 col-xs-8">'
  ...
  var addonTypeTemplate = _.template(
      '<form class="form-horizontal">'
    +  '<div class="form-group">'
    +   '<label class="section-label control-label col-md-5 col-xs-5"><%= sectionLabel %></label>'
    +  '</div>'
    +  '<% addons.forEach(function(addon) { %>'
    +   '<div class="form-group">'
    +    '<label for="<%= addon.title %>" class="control-label col-md-4 col-xs-4"><%= addon.title %></label>'
  ...
  var totalsTemplate = _.template(
    ...
    +  '<div class="form-group">'
    +   '<label for="subtotal" class="total-label control-label col-md-4 col-xs-4">Kickstarter</label>'
    +   '<div class="col-md-4 col-xs-4">'
    +    '<p id="subtotal" class="form-control-static">$0</p>'
    +   '</div>'
    +  '</div>'
    +  '<div class="form-group">'
    +   '<label for="wave1" class="total-label control-label col-md-4 col-xs-4">Wave 1 (2017)</label>'
    +   '<div class="col-md-4 col-xs-4">'
    +    '<p id="wave1" class="form-control-static">$0</p>'
    +   '</div>'
    +  '</div>'
    +  '<div class="form-group">'
    +   '<label for="wave2" class="total-label control-label col-md-4 col-xs-4">Wave 2 (2017)</label>'
    +   '<div class="col-md-4 col-xs-4">'
    +    '<p id="wave2" class="form-control-static">$0</p>'
    +   '</div>'
    +  '</div>'
    +  '<div class="form-group">'
    +   '<label for="wave3" class="total-label control-label col-md-4 col-xs-4">Wave 3 (2018)</label>'
    +   '<div class="col-md-4 col-xs-4">'
    +    '<p id="wave3" class="form-control-static">$0</p>'
    +   '</div>'
    +  '</div>'
    +  '<div class="form-group">'
    +   '<label for="wave4" class="total-label control-label col-md-4 col-xs-4">Wave 4 (2019)</label>'
    +   '<div class="col-md-4 col-xs-4">'
    +    '<p id="wave4" class="form-control-static">$0</p>'
    +   '</div>'
    +  '</div>'
    +  '<div class="form-group">'
    +   '<label for="wave5" class="total-label control-label col-md-4 col-xs-4">Wave 5 (2020)</label>'
    +   '<div class="col-md-4 col-xs-4">'
    +    '<p id="wave5" class="form-control-static">$0</p>'
    +   '</div>'
    +  '</div>'
    +  '<div class="form-group">'
    +   '<label for="total" class="total-label control-label col-md-4 col-xs-4">Total</label>'
    +   '<div class="col-md-4 col-xs-4">'
